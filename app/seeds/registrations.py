...
def seed_registrations():
    ...
    registration = Registration(user_id='1', event_id='1')
    ...
    db.session.add(registration)
    registration = Registration(user_id='1', event_id='2')
    db.session.add(registration)
    ...
    db.session.add(registration)
    registration = Registration(user_id='1', event_id='3')
    db.session.add(registration)
    ...
    db.session.add(registration)
    registration = Registration(user_id='1', event_id='4')
    db.session.add(registration)
