...
def seed_categories():
    ...
    db.session.add(category)
    category = Category(category='Overwatch')
    db.session.add(category)
    ...
    db.session.add(category)
    category = Category(category='Fall Guys')
    db.session.add(category)
    category = Category(category='Diablo III')
    db.session.add(category)
    category = Category(category='Monster Hunter')
    db.session.add(category)
    category = Category(category='Destiny 2')
    db.session.add(category)
